...
['zh','id'].forEach(lang => {
  ...
  if (lang === 'zh') {
    ...
    c = c.replace('A community rooted in Bali', '植根于巴厘岛的社区');
    c = c.replace('section-header__tag">The Concept', 'section-header__tag">设计理念');
    ...
    c = c.replace('>Community Pool<', '>社区泳池<');
    ...
    c = c.replace('A community rooted in Bali', 'Komunitas yang berakar di Bali');
    c = c.replace('section-header__tag">The Concept', 'section-header__tag">Konsep');
    ...
    c = c.replace('>Community Pool<', '>Kolam Renang Komunitas<');
