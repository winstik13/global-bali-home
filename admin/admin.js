...
(function () {
  ...
  const ADMIN_I18N = {
    en: {
      ...
      'bb.colors.desc': 'Palette is organised by <strong>role</strong>, not by «main / supporting». Following industry best practice (Apple, Stripe, Aman, IBM Carbon) we avoid pure black and pure white in main usage: our dark base <code>#1a1a14</code> and main text <code>#E1D9C9</code> are warm off-tones that reduce eye strain and give the brand its character. Pure White is kept as an escape hatch (icons on photos, print on coloured stock).',
      'bb.colors.coreSurfaces': 'Core Surfaces & Text',
      'bb.colors.functional': 'Functional / Status',
      'bb.colors.functionalDesc': 'Used for state communication, not for decoration. Success states reuse Accent Green to keep the palette tight. WhatsApp is a third-party brand colour — locked by Meta, never adjusted.',
      'bb.colors.alias': 'Alias of Accent Green',
      'bb.colors.role.bgPrimary': 'Page background, hero, footer',
      'bb.colors.role.bgSurface': 'Cards, raised panels, hover',
      'bb.colors.role.cream': 'All body text, light surfaces — 90%',
      'bb.colors.role.creamLight': 'Inverted surfaces, forms — 9%',
      'bb.colors.role.white': 'Escape hatch — icons, print — 1%',
      'bb.colors.role.accent': 'Eyebrows, progress, links, success',
      'bb.colors.role.success': '= Accent Green. Availability bars, ✓ states',
      'bb.colors.role.presale': 'Pre-launch tags, warning badges',
      'bb.colors.role.error': 'Form errors, destructive. Use Light (#e74c3c) on dark for body, Deep (#c0392b) only for headlines/large',
      'bb.colors.role.whatsapp': 'External brand colour. WhatsApp buttons only — do not adjust',
      'bb.typo.title': 'Typography',
      'bb.typo.desc': 'Two-typeface system. <strong>Playfair Display</strong> — serif, classical, premium — used for display and all headings. <strong>Montserrat</strong> — geometric sans-serif — used for body copy, navigation, UI labels and metadata. The combination gives the brand its editorial-yet-modern voice.',
      ...
      'bb.typo.scaleDesc': 'Modular scale based on 16px / 1rem. Headings — <strong>Playfair Display</strong> Regular, line-height 1.2, letter-spacing −2% (tight, premium feel). Body — <strong>Montserrat</strong>, line-height 1.6, neutral spacing. Eyebrow labels stay Montserrat SemiBold UPPER with wide spacing. H4–H6 use Montserrat SemiBold to keep small text legible. Samples shown in Latin and Cyrillic.',
      // Voice
      'bb.voice.title': 'Tone of Voice',
      'bb.voice.intro': "How Global Bali Home sounds in every channel — from a sales call to an Instagram caption. Four attributes define the voice; combine them, don't pick one. Draft, refine with team.",
      ...
      'bb.colors.tintsDesc': "Two 10-stop scales cover all interface needs. <strong>Neutral</strong> goes from Cream Light to Bg Primary — use for text variants, borders, dividers, surface elevation, disabled states. <strong>Accent</strong> expands the brand green — use for hover/active states, focus rings, success variants. ◉ marks the base brand colour. Click any stop to copy.",
      'bb.colors.combos': 'Approved Combinations',
      'bb.colors.combosDesc': 'Curated colour pairings for backgrounds, surfaces, and accent moments. Each combination has been tested for contrast. Apply the 60-30-10 rule: 60% main background, 30% secondary surface, 10% accent.',
      'bb.colors.wcag': 'Accessibility — WCAG Contrast',
      'bb.colors.wcagDesc': "Every approved text/background pair is validated against WCAG 2.1 contrast ratios. AA requires 4.5:1 for normal text, AAA requires 7:1. All combinations below pass AAA, meaning they're readable for users with reduced vision.",
      ...
      'bb.ui.intro': 'Baseline interface elements rendered in brand colours. Apply the same patterns on the marketing site, landing pages, dashboards, and printed forms. All components must remain functional in both light (Cream) and dark (Deep Green) modes.',
    ...
    ru: {
      ...
      'bb.colors.desc': 'Палитра построена <strong>по ролям</strong>, а не по «основные / дополнительные». Следуя индустриальной практике (Apple, Stripe, Aman, IBM Carbon), мы избегаем чистого чёрного и белого в основном использовании: тёмная база <code>#1a1a14</code> и основной текст <code>#E1D9C9</code> — тёплые off-тона, снижающие усталость глаз и задающие характер бренду. Чистый белый оставлен как escape-вариант (иконки на фото, печать на цветной бумаге).',
      'bb.colors.coreSurfaces': 'Основные поверхности и текст',
      'bb.colors.functional': 'Функциональные / статусные',
      'bb.colors.functionalDesc': 'Используются для коммуникации состояний, не для декора. Success-состояния используют Accent Green, чтобы не плодить оттенки. WhatsApp — внешний бренд-цвет, зафиксирован Meta, не подгоняем.',
      'bb.colors.alias': 'Алиас Accent Green',
      'bb.colors.role.bgPrimary': 'Фон страницы, hero, футер',
      'bb.colors.role.bgSurface': 'Карточки, поднятые панели, hover',
      'bb.colors.role.cream': 'Весь основной текст, светлые поверхности — 90%',
      'bb.colors.role.creamLight': 'Инверсные поверхности, формы — 9%',
      'bb.colors.role.white': 'Escape-вариант — иконки, печать — 1%',
      'bb.colors.role.accent': 'Eyebrows, прогресс, ссылки, success',
      'bb.colors.role.success': '= Accent Green. Полоски доступности, состояния ✓',
      'bb.colors.role.presale': 'Pre-launch тэги, warning-бэйджи',
      'bb.colors.role.error': 'Ошибки форм, разрушительные действия. Light (#e74c3c) на тёмном для текста, Deep (#c0392b) только для заголовков/крупного',
      'bb.colors.role.whatsapp': 'Внешний бренд-цвет. Только для WhatsApp-кнопок — не подгонять',
      'bb.typo.title': 'Типографика',
      'bb.typo.desc': 'Система из двух шрифтов. <strong>Playfair Display</strong> — антиква, классическая, премиальная — для display и всех заголовков. <strong>Montserrat</strong> — геометрический гротеск — для основного текста, навигации, UI-меток и метаданных. Их сочетание задаёт характер бренда: «редакционно, но современно».',
      ...
      'bb.typo.scaleDesc': 'Модульная шкала на базе 16px / 1rem. Заголовки — <strong>Playfair Display</strong> Regular, межстрочный 1.2, межбуквенный −2% (плотно, премиально). Основной текст — <strong>Montserrat</strong>, межстрочный 1.6, нейтральный трекинг. Eyebrow-метки — Montserrat SemiBold UPPER с широким межбуквенным. H4–H6 — Montserrat SemiBold для читаемости в малых размерах. Образцы на латинице и кириллице.',
      // Voice
      'bb.voice.title': 'Тон коммуникации',
      'bb.voice.intro': 'Как Global Bali Home звучит во всех каналах — от телефонного звонка до подписи в Instagram. Голос задаёт четыре атрибута; их нужно сочетать, а не выбирать один. Драфт, дорабатывается с командой.',
      ...
      'bb.colors.tintsDesc': 'Две 10-ступенчатые шкалы покрывают все нужды интерфейса. <strong>Neutral</strong> — от Cream Light до Bg Primary, для вариантов текста, рамок, разделителей, уровней поверхностей, disabled. <strong>Accent</strong> — расширение бренд-зелёного, для hover/active, focus, success-вариантов. ◉ — базовый бренд-цвет. Клик по ступени — копирование.',
      'bb.colors.combos': 'Одобренные сочетания',
      'bb.colors.combosDesc': 'Подобранные пары для фона, поверхностей и акцентов. Каждое сочетание прошло проверку контраста. Правило 60-30-10: 60% основной фон, 30% вторичная поверхность, 10% акцент.',
      'bb.colors.wcag': 'Доступность — WCAG-контраст',
      'bb.colors.wcagDesc': 'Каждая одобренная пара текст/фон проверена по WCAG 2.1. AA требует 4.5:1 для обычного текста, AAA — 7:1. Все комбинации ниже проходят AAA, то есть читаемы и для пользователей со сниженным зрением.',
      ...
      'bb.ui.intro': 'Базовые интерфейсные элементы в цветах бренда. Применять одинаково на маркетинговом сайте, лендингах, в дашбордах и печатных формах. Компоненты должны работать и в светлой (Cream), и в тёмной (Deep Green) теме.',
