...
(function () {
  ...
  const ADMIN_I18N = {
    en: {
      ...
      'bb.colors.tintsDesc': "Each brand colour expanded into a 10-stop scale (50 lightest → 900 darkest). Use for hover states, borders, dividers, disabled UI, charts. The numbered base sits at 500–800 depending on the colour. Click any swatch to copy.",
    ...
    ru: {
      ...
      'bb.colors.tintsDesc': 'Каждый цвет бренда расширен в 10-ступенчатую шкалу (50 — самый светлый → 900 — самый тёмный). Используем для hover, рамок, разделителей, disabled UI, графиков. База лежит на 500–800 в зависимости от цвета. Клик по плашке — копирование.',
