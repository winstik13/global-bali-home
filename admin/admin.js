...
(function () {
  ...
  const ADMIN_I18N = {
    en: {
      ...
      'contacts.hint.phone': 'Display format, e.g. +62 819 5901 7052',
      ...
      'help.contacts.whatsapp': '<strong>WhatsApp:</strong> DIGITS ONLY, no +, spaces or dashes. Example: 6281959017052',
      ...
      'bb.voice.ex1.yes': '"Leasehold: 30 years initial + 30-year extension under signed PPJB."',
      'bb.voice.ex1.no': '"60-year ownership!" <em>(misleading — extension is conditional)</em>',
      ...
      'bb.colors.app.heroTitle': 'Structured assets on Bali — 30+30 leasehold, verifiable title',
      ...
      'bb.typo.comp.lede': '12 villas. 3 available. Leasehold 30 + 30 years with verifiable PPJB. Managed rental delivers 10–12% per year, reports quarterly. We don’t sell square metres — we deliver a structured asset.',
      'bb.typo.comp.cta': 'Reserve a viewing',
      'bb.typo.comp.col1title': 'Legal title',
      'bb.typo.comp.col1desc': 'PT-PMA structure, leasehold 30 years initial + 30 years extension under signed PPJB. Documents in your name, taxes filed quarterly.',
      ...
      'bb.ml.r3n': '"60 years" misleading · superlatives · false urgency.',
      'bb.ml.r4n': 'Calque "эстейт" · "коридор Убуда" · transliterated brand · "60 years".',
      ...
      'bb.voice.para1.body': 'Serenity Villas — twelve 2-bedroom villas in central Ubud. Handover Q4 2026. Title — leasehold 30 years + 30-year extension under signed PPJB. 3 of 12 units available, prices from $189,000. Managed rental delivers 10–12% per year, reports quarterly.',
      ...
      'bb.voice.matrix.q3.desc': 'Conversational but precise. "How leasehold 30+30 works" — with numbers and formula, in human language.',
      ...
      'bb.fnd.sageDesc': 'We educate the client: explain UU 7/2011, the PT-PMA structure, the difference between 30+30 and "60 years". We don’t push, we don’t rush. The client decides on knowledge, not emotion.',
      ...
      'bb.fnd.pyr.attributes': 'Leasehold 30+30 · PT-PMA · quarterly reports · international architects',
    ...
    ru: {
      ...
      'contacts.hint.phone': 'Формат отображения, напр. +62 819 5901 7052',
      ...
      'help.contacts.whatsapp': '<strong>WhatsApp:</strong> ТОЛЬКО ЦИФРЫ, без +, пробелов или дефисов. Пример: 6281959017052',
      ...
      'bb.voice.ex1.yes': '«Leasehold: 30 лет начально + 30 лет продления по подписанному PPJB.»',
      'bb.voice.ex1.no': '«Владение на 60 лет!» <em>(вводит в заблуждение — продление условное)</em>',
      ...
      'bb.colors.app.heroTitle': 'Структурированные активы на Бали — 30+30 leasehold, проверяемое право',
      ...
      'bb.typo.comp.lede': '12 вилл. 3 доступны. Leasehold 30 + 30 лет с проверяемым PPJB. Управляемая аренда даёт 10–12% годовых, отчёты квартальные. Мы не продаём квадратные метры — мы передаём структурированный актив.',
      'bb.typo.comp.cta': 'Записаться на показ',
      'bb.typo.comp.col1title': 'Право собственности',
      'bb.typo.comp.col1desc': 'Структура PT-PMA, leasehold 30 лет первичная + 30 лет продление под подписанным PPJB. Документы оформлены на ваше имя, налоги — квартально.',
      ...
      'bb.ml.r3n': '«60 years» вводит в заблуждение · superlatives · false urgency.',
      'bb.ml.r4n': 'Калька «эстейт» · «коридор Убуда» · транслит бренда · «60 лет».',
      ...
      'bb.voice.para1.body': 'Serenity Villas — двенадцать вилл на 2 спальни в районе центрального Убуда. Сдача — Q4 2026. Право — leasehold 30 лет + продление 30 лет под подписанным PPJB. Доступно 3 из 12 юнитов, цены от $189 000. Управляемая аренда даёт 10–12% годовых, отчёты квартальные.',
      ...
      'bb.voice.matrix.q3.desc': 'Разговорно, но точно. «Как считается leasehold 30+30» — с цифрами и формулой, но человеческим языком.',
      'bb.voice.matrix.q3.use': '→ FAQ, help center, knowledge base',
      'bb.voice.matrix.q4.title': 'Social, newsletter',
      ...
      'bb.fnd.sageDesc': 'Мы образовываем клиента: объясняем закон UU 7/2011, структуру PT-PMA, разницу 30+30 vs «60 лет». Не давим, не торопим. Решение клиент принимает на знаниях, а не на эмоциях.',
      ...
      'bb.fnd.pyr.attributes': 'Leasehold 30+30 · PT-PMA · квартальные отчёты · международные архитекторы',
