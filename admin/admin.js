...
(function () {
  ...
  const ADMIN_I18N = {
    en: {
      ...
      'bb.typo.scaleDesc': 'Modular scale based on 16px / 1rem with a ratio of 1.25 (major third). Headings use 4% letter-spacing and 130% line-height, weight 600–700. Body uses 0 letter-spacing and 130% line-height. Samples shown in Latin and Cyrillic.',
      // Voice
    ...
    ru: {
      ...
      'bb.typo.scaleDesc': 'Модульная шкала на базе 16px / 1rem с шагом 1.25 (большая терция). Заголовки: межбуквенный 4%, межстрочный 130%, насыщенность 600–700. Основной текст: межбуквенный 0, межстрочный 130%. Образцы на латинице и кириллице.',
      // Voice
