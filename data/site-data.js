...
/* Source: Supabase site_content[site] · updated 2026-04-27T10:53:02.936706+00:00 */
const SITE_DATA = {
  "roi": {
    "step": 10000,
    "texts": {
  ...
  "tourPopup": {
    ...
    "steps": {
      ...
      "id": [
        ...
        },
        {
          "multi": true,
          "options": [
            "Kunjungan lokasi konstruksi",
            "Bertemu arsitek",
            "Tinjauan ketentuan investasi",
            "Lihat villa yang selesai",
            "Jelajahi area"
          ],
    ...
    "thankYou": {
      ...
      "id": {
        "text": "Manajer kami akan menghubungi Anda dalam 2 jam untuk mengatur detailnya.",
        "title": "Permintaan Tur Terkirim!",
        "whatsapp": "Hubungi kami di WhatsApp",
        "projectLink": "Pelajari lebih lanjut tentang"
      },
      "ru": {
